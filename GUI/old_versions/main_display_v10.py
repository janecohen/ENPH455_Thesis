...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.loadSettings()
        print("Settings uploaded for all scopes")
        ...
        self.plot_1_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_1_title_label,
        ...
        self.plot_2_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_2_title_label,
        ...
        self.plot_3_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_3_title_label,
        ...
        self.plot_4_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_4_title_label,
        ...
        self.plot_5_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_5_title_label,
        ...
        self.plot_6_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_6_title_label,
        ...
        self.plot_7_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_7_title_label,
        ...
        self.plot_8_scope_comboBox.currentIndexChanged.connect(
            lambda: self.load_and_plot_data(self.plot_8_title_label,
    ...
    def setPlotTitle(self, plot_title, selected_scope, selected_channel):
        ...
        with open(csv_file_path, mode='r') as csvfile:
            ...
            for row in reader:
                if(row["Channel"] == 'A'):
                    ...
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[0]}", row["Channel name"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[1]}", row["Collect data"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[2]}", row["Voltage range"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[3]}", row["Sampling rate"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[4]}", row["Autotrigger"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[5]}", row["Coupling mode"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[6]}", row["Threshold"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[7]}", row["Direction"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[8]}", row["Delay"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[9]}", row["Presample"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[10]}", row["Postsample"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[11]}", row["Extra1"])
                    settings.setValue(f"Scope {currentScope}/{chA_attributes[12]}", row["Extra2"])
                else:
                    currentScope = row["Scope"]
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[0]}", row["Channel name"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[1]}", row["Collect data"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[2]}", row["Voltage range"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[3]}", row["Sampling rate"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[4]}", row["Autotrigger"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[5]}", row["Coupling mode"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[6]}", row["Threshold"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[7]}", row["Direction"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[8]}", row["Delay"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[9]}", row["Presample"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[10]}", row["Postsample"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[11]}", row["Extra1"])
                    settings.setValue(f"Scope {currentScope}/{chB_attributes[12]}", row["Extra2"])

                
    def load_and_plot_data(self, plot_title, plot_widget, selected_scope, selected_channel):
        # Check if valid selections are made
        if selected_scope != "Select scope" and selected_channel != "Select channel":

            # set plot title
            self.setPlotTitle(plot_title, selected_scope, selected_channel)
