...
class Ui_ScopeControlWindow(object):
    def setupUi(self, ScopeControlWindow):
        ...
        ScopeControlWindow.resize(834, 707)
...
"}")
        ...
        self.gridLayout.addWidget(self.chA_direction_label, 9, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.chA_threshold_label, 8, 0, 1, 1)
        ...
        self.chA_triggering_label = QtWidgets.QLabel(self.channel_A_groupBox)
        self.chA_triggering_label.setObjectName("chA_triggering_label")
        self.gridLayout.addWidget(self.chA_triggering_label, 6, 0, 1, 3)
...
"}")
        ...
        self.gridLayout.addWidget(self.chA_threshold_hover, 8, 5, 1, 1)
        ...
        self.chA_direction_lineEdit = QtWidgets.QLineEdit(self.channel_A_groupBox)
        self.chA_direction_lineEdit.setObjectName("chA_direction_lineEdit")
        self.gridLayout.addWidget(self.chA_direction_lineEdit, 9, 3, 1, 1)
...
"}")
        ...
        self.chA_triggering_comboBox = QtWidgets.QComboBox(self.channel_A_groupBox)
        self.chA_triggering_comboBox.setObjectName("chA_triggering_comboBox")
        self.gridLayout.addWidget(self.chA_triggering_comboBox, 6, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.chA_threshold_lineEdit, 8, 3, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.chA_direction_hover, 9, 5, 1, 1)
        ...
        self.chA_triggering_hover = QtWidgets.QLabel(self.channel_A_groupBox)
        self.chA_triggering_hover.setStyleSheet("QLabel{\n"
"    background-color: rgb(110,110,186);\n"
"    padding: 0px;\n"
"    border-radius: 5px;\n"
"    font: 75 10pt \"Candara\";\n"
"}")
        self.chA_triggering_hover.setObjectName("chA_triggering_hover")
        self.gridLayout.addWidget(self.chA_triggering_hover, 6, 5, 1, 1)
...
"}")
        ...
        self.chB_direction_lineEdit = QtWidgets.QLineEdit(self.channel_B_groupBox)
        self.chB_direction_lineEdit.setObjectName("chB_direction_lineEdit")
        self.gridLayout_2.addWidget(self.chB_direction_lineEdit, 9, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chB_threshold_lineEdit, 8, 3, 1, 1)
        ...
        self.checkBox_2 = QtWidgets.QCheckBox(self.channel_B_groupBox)
        self.checkBox_2.setText("")
        self.checkBox_2.setObjectName("checkBox_2")
        self.gridLayout_2.addWidget(self.checkBox_2, 2, 2, 1, 2)
...
"}")
        ...
        self.chB_triggering_comboBox = QtWidgets.QComboBox(self.channel_B_groupBox)
        self.chB_triggering_comboBox.setObjectName("chB_triggering_comboBox")
        self.gridLayout_2.addWidget(self.chB_triggering_comboBox, 6, 3, 1, 2)
        ...
        self.chB_triggering_hover = QtWidgets.QLabel(self.channel_B_groupBox)
        self.chB_triggering_hover.setStyleSheet("QLabel{\n"
"    background-color: rgb(110,110,186);\n"
"    padding: 0px;\n"
"    border-radius: 5px;\n"
"    font: 75 10pt \"Candara\";\n"
"}")
        self.chB_triggering_hover.setObjectName("chB_triggering_hover")
        self.gridLayout_2.addWidget(self.chB_triggering_hover, 6, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chB_threshold_label, 8, 0, 1, 1)
...
"}")
        ...
        self.chB_triggering_label = QtWidgets.QLabel(self.channel_B_groupBox)
        self.chB_triggering_label.setObjectName("chB_triggering_label")
        self.gridLayout_2.addWidget(self.chB_triggering_label, 6, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.chB_direction_label, 9, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.chB_threshold_hover, 8, 5, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.chB_direction_hover, 9, 5, 1, 1)
...
"}")
    ...
    def retranslateUi(self, ScopeControlWindow):
        ...
        self.chA_presample_label.setText(_translate("ScopeControlWindow", "Pre sample triggers:"))
        ...
        self.chA_triggering_label.setText(_translate("ScopeControlWindow", "Triggering:"))
        ...
        self.chA_triggering_hover.setText(_translate("ScopeControlWindow", "  ?"))
        ...
        self.chB_triggering_hover.setText(_translate("ScopeControlWindow", "  ?"))
        self.chB_rate_label.setText(_translate("ScopeControlWindow", "Sampling rate:"))
        ...
        self.chB_triggering_label.setText(_translate("ScopeControlWindow", "Triggering:"))
