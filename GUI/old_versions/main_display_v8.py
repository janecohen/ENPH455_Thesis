...
class Ui_MainWindow(object):
    ...
    def setPlotTitle(self, selected_scope, selected_channel):
        settings = QSettings("JC", "PlottingBananza") # company, application name
        print("Scope:", selected_scope, "Channel:", selected_channel)
        
        if (selected_channel == 'Channel A'):
            name = settings.value(f"{selected_scope}/{chA_attributes[0]}", "")
            if (selected_scope == "Scope 1"):
                self.plot_1_title_label.setText(name)  
            elif (selected_scope == "Scope 2"):
                self.plot_2_title_label.setText(name)
            elif (selected_scope == "Scope 3"):
                self.plot_3_title_label.setText(name)
            elif (selected_scope == "Scope 4"):
                self.plot_4_title_label.setText(name)
        else:
    ...
    def load_and_plot_data(self, plot_widget, selected_scope, selected_channel):
        ...
        if selected_scope != "Select scope" and selected_channel != "Select channel":
            ...
            # set plot title
            self.setPlotTitle(selected_scope, selected_channel)
